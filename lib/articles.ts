...
export const seoArticles = [
  {
    ...
    sections: [
      ...
      { heading: 'ArcadeNexa vs other unblocked game sites', body: 'Unlike Unblocked Games 76 or similar sites, ArcadeNexa offers a modern interface, mobile-friendly design, and 13,000+ curated HTML5 games from trusted providers. No outdated Flash content, no broken links, and no sketchy ads.' },
    ],
    faq: [
  ...
  },
  {
    ...
    sections: [
      { heading: 'What makes a game truly free to play', body: 'A genuinely free browser game requires no purchase, no subscription, and no account creation. ArcadeNexa offers 13,000+ games that are completely free, with no login required. Simply click a game and start playing in seconds.' },
    ...
    faq: [
      { question: 'Are all games on ArcadeNexa really free?', answer: 'Yes. All 13,000+ games on ArcadeNexa are free to play with no login or payment required.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'How to find new games quickly', body: 'ArcadeNexa organizes 13,000+ games across 47 categories. Browse by genre, check the trending section for popular titles, or search for a specific game type. Every game starts instantly with no account needed.' },
    ],
    faq: [
