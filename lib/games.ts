...
export const games: Game[] = [
  ...
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/moto-maniac-2.svg', providerGameId: 'moto-maniac-2', officialUrl: 'https://www.gamepix.com/play/moto-maniac-2'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/getting-over-it.svg', providerGameId: 'getting-over-it', officialUrl: 'https://www.gamepix.com/play/getting-over-it'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/connect-the-bubbles.svg', providerGameId: 'connect-the-bubbles', officialUrl: 'https://www.gamepix.com/play/connect-the-bubbles'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/gemcrafter.svg', providerGameId: 'gemcrafter', officialUrl: 'https://www.gamepix.com/play/gemcrafter'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/solitaire-gpx.svg', providerGameId: 'solitaire-gpx', officialUrl: 'https://www.gamepix.com/play/solitaire-gpx'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/minesweeper.svg', providerGameId: 'minesweeper', officialUrl: 'https://www.gamepix.com/play/minesweeper'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/2048.svg', providerGameId: '2048', officialUrl: 'https://www.gamepix.com/play/2048'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/daily-solitaire-blue.svg', providerGameId: 'daily-solitaire-blue', officialUrl: 'https://www.gamepix.com/play/daily-solitaire-blue'
  }),
  ...
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/tentrix.svg', providerGameId: 'tentrix', officialUrl: 'https://www.gamepix.com/play/tentrix'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-blue-500/30 to-pink-500/30', thumbnail: '/images/gamepix/10x10.svg', providerGameId: '10x10', officialUrl: 'https://www.gamepix.com/play/10x10'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-red-500/30 to-blue-500/30', thumbnail: '/images/gamepix/kobadoo-flags.svg', providerGameId: 'kobadoo-flags', officialUrl: 'https://www.gamepix.com/play/kobadoo-flags'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-orange-500/30 to-yellow-500/30', thumbnail: '/images/gamepix/my-parking-lot.svg', providerGameId: 'my-parking-lot', officialUrl: 'https://www.gamepix.com/play/my-parking-lot'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-red-500/30 to-purple-500/30', thumbnail: '/images/gamepix/ballistic.svg', providerGameId: 'ballistic', officialUrl: 'https://www.gamepix.com/play/ballistic'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-slate-500/30 to-amber-500/30', thumbnail: '/images/gamepix/100-doors-escape-from-prison.svg', providerGameId: '100-doors-escape-from-prison', officialUrl: 'https://www.gamepix.com/play/100-doors-escape-from-prison'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-fuchsia-500/30 to-cyan-500/30', thumbnail: '/images/gamepix/prism-match-3d.svg', providerGameId: 'prism-match-3d', officialUrl: 'https://www.gamepix.com/play/prism-match-3d'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-pink-500/30 to-amber-500/30', thumbnail: '/images/gamepix/art-puzzle.svg', providerGameId: 'art-puzzle', officialUrl: 'https://www.gamepix.com/play/art-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-emerald-500/30 to-blue-500/30', thumbnail: '/images/gamepix/path-puzzle.svg', providerGameId: 'path-puzzle', officialUrl: 'https://www.gamepix.com/play/path-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-blue-500/30 to-orange-500/30', thumbnail: '/images/gamepix/puzzle-drive.svg', providerGameId: 'puzzle-drive', officialUrl: 'https://www.gamepix.com/play/puzzle-drive'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-zinc-500/30 to-cyan-500/30', thumbnail: '/images/gamepix/screw-puzzle.svg', providerGameId: 'screw-puzzle', officialUrl: 'https://www.gamepix.com/play/screw-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-lime-500/30 to-pink-500/30', thumbnail: '/images/gamepix/goods-sort-puzzle.svg', providerGameId: 'goods-sort-puzzle', officialUrl: 'https://www.gamepix.com/play/goods-sort-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-sky-500/30 to-violet-500/30', thumbnail: '/images/gamepix/puzzlebot.svg', providerGameId: 'puzzlebot', officialUrl: 'https://www.gamepix.com/play/puzzlebot'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-green-500/30 to-blue-500/30', thumbnail: '/images/gamepix/slime-adventure.svg', providerGameId: 'slime-adventure', officialUrl: 'https://www.gamepix.com/play/slime-adventure'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-indigo-500/30 to-amber-500/30', thumbnail: '/images/gamepix/platforms.svg', providerGameId: 'platforms', officialUrl: 'https://www.gamepix.com/play/platforms'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-red-500/30 to-slate-500/30', thumbnail: '/images/gamepix/f1-racing-game.svg', providerGameId: 'f1-racing-game', officialUrl: 'https://www.gamepix.com/play/f1-racing-game'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-orange-500/30 to-blue-500/30', thumbnail: '/images/gamepix/racing-cars-game.svg', providerGameId: 'racing-cars-game', officialUrl: 'https://www.gamepix.com/play/racing-cars-game'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-purple-500/30 to-yellow-500/30', thumbnail: '/images/gamepix/street-racing.svg', providerGameId: 'street-racing', officialUrl: 'https://www.gamepix.com/play/street-racing'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-green-500/30 to-cyan-500/30', thumbnail: '/images/gamepix/goals.svg', providerGameId: 'goals', officialUrl: 'https://www.gamepix.com/play/goals'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-red-500/30 to-yellow-500/30', thumbnail: '/images/gamepix/smash-karts.svg', providerGameId: 'smash-karts', officialUrl: 'https://www.gamepix.com/play/smash-karts'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-blue-500/30 to-orange-500/30', thumbnail: '/images/gamepix/madalin-stunt-cars-2.svg', providerGameId: 'agame-stunt-car', officialUrl: 'https://www.gamepix.com/play/agame-stunt-car'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-violet-500/30 to-emerald-500/30', thumbnail: '/images/gamepix/dynamons.svg', providerGameId: 'dynamons', officialUrl: 'https://www.gamepix.com/play/dynamons'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-yellow-500/30 to-red-500/30', thumbnail: '/images/gamepix/bomber-friends.svg', providerGameId: 'bomber-friends', officialUrl: 'https://www.gamepix.com/play/bomber-friends'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/body-drop-3d.svg', providerGameId: 'body-drop-3d', officialUrl: 'https://www.gamepix.com/play/body-drop-3d'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/bloxd-io.svg', providerGameId: 'bloxd-io', officialUrl: 'https://www.gamepix.com/play/bloxd-io'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/slope-racing-3d.svg', providerGameId: 'slope-racing-3d', officialUrl: 'https://www.gamepix.com/play/slope-racing-3d'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/yummy-tales.svg', providerGameId: 'yummy-tales', officialUrl: 'https://www.gamepix.com/play/yummy-tales'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/dragon-simulator-3d.svg', providerGameId: 'dragon-simulator-3d', officialUrl: 'https://www.gamepix.com/play/dragon-simulator-3d'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/rovercraft.svg', providerGameId: 'rovercraft', officialUrl: 'https://www.gamepix.com/play/rovercraft'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/mr-racer-car-racing-game.svg', providerGameId: 'mr-racer-car-racing-game', officialUrl: 'https://www.gamepix.com/play/mr-racer-car-racing-game'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/demolition-derby-life.svg', providerGameId: 'demolition-derby-life', officialUrl: 'https://www.gamepix.com/play/demolition-derby-life'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/ultimate-offroad-cars-2.svg', providerGameId: 'ultimate-offroad-cars-2', officialUrl: 'https://www.gamepix.com/play/ultimate-offroad-cars-2'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30', thumbnail: '/images/gamepix/dynamons-6.svg', providerGameId: 'dynamons-6', officialUrl: 'https://www.gamepix.com/play/dynamons-6'
  }),
  createGamePixGame({
    ...
    thumbnail: '/images/gamepix/basketball-stars.svg', providerGameId: 'basketball-stars', officialUrl: 'https://www.gamepix.com/play/basketball-stars'
  }),
  createGamePixGame({
  ...
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/copa-toon.svg', providerGameId: 'copa-toon', officialUrl: 'https://www.gamepix.com/play/copa-toon'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/flip-trickster-parkour-simulator.svg', providerGameId: 'flip-trickster-parkour-simulator', officialUrl: 'https://www.gamepix.com/play/flip-trickster-parkour-simulator'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/3d-bowling.svg', providerGameId: '3d-bowling', officialUrl: 'https://www.gamepix.com/play/3d-bowling'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/8-ball-billiards-classic.svg', providerGameId: '8-ball-billiards-classic', officialUrl: 'https://www.gamepix.com/play/8-ball-billiards-classic'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/boxing-stars.svg', providerGameId: 'boxing-stars', officialUrl: 'https://www.gamepix.com/play/boxing-stars'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/classic-bowling.svg', providerGameId: 'classic-bowling', officialUrl: 'https://www.gamepix.com/play/classic-bowling'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/race.svg', providerGameId: 'race', officialUrl: 'https://www.gamepix.com/play/race'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/racing-project-kit.svg', providerGameId: 'racing-project-kit', officialUrl: 'https://www.gamepix.com/play/racing-project-kit'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/boat-drive.svg', providerGameId: 'boat-drive', officialUrl: 'https://www.gamepix.com/play/boat-drive'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/moto-x3m-spooky-land.svg', providerGameId: 'moto-x3m-spooky-land', officialUrl: 'https://www.gamepix.com/play/moto-x3m-spooky-land'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/moon-city-stunt.svg', providerGameId: 'moon-city-stunt', officialUrl: 'https://www.gamepix.com/play/moon-city-stunt'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/traffic-car-racing-game.svg', providerGameId: 'traffic-car-racing-game', officialUrl: 'https://www.gamepix.com/play/traffic-car-racing-game'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/vex-x3m.svg', providerGameId: 'vex-x3m', officialUrl: 'https://www.gamepix.com/play/vex-x3m'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/agent-action.svg', providerGameId: 'agent-action', officialUrl: 'https://www.gamepix.com/play/agent-action'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/ghost-sniper.svg', providerGameId: 'ghost-sniper', officialUrl: 'https://www.gamepix.com/play/ghost-sniper'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/1942-pacific-front.svg', providerGameId: '1942-pacific-front', officialUrl: 'https://www.gamepix.com/play/1942-pacific-front'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/mountain-tank.svg', providerGameId: 'mountain-tank', officialUrl: 'https://www.gamepix.com/play/mountain-tank'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/grand-zombie-swarm-2.svg', providerGameId: 'grand-zombie-swarm-2', officialUrl: 'https://www.gamepix.com/play/grand-zombie-swarm-2'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/endless-siege.svg', providerGameId: 'endless-siege', officialUrl: 'https://www.gamepix.com/play/endless-siege'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/creative-puzzle.svg', providerGameId: 'creative-puzzle', officialUrl: 'https://www.gamepix.com/play/creative-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/image-puzzle.svg', providerGameId: 'image-puzzle', officialUrl: 'https://www.gamepix.com/play/image-puzzle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/super-onion-boy.svg', providerGameId: 'super-onion-boy', officialUrl: 'https://www.gamepix.com/play/super-onion-boy'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/fireboy-and-watergirl-forest-temple.svg', providerGameId: 'fireboy-and-watergirl-forest-temple', officialUrl: 'https://www.gamepix.com/play/fireboy-and-watergirl-forest-temple'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/stickman-hook.svg', providerGameId: 'stickman-hook', officialUrl: 'https://www.gamepix.com/play/stickman-hook'
  }),
  createGamePixGame({
    ...
    rating: 7.8, platform: 'Multi', releaseYear: 2025, category: 'Action', initials: 'GS',
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/getaway-shootout.svg', providerGameId: 'getaway-shootout', officialUrl: 'https://www.gamepix.com/play/getaway-shootout'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/zombs-royale-io.svg', providerGameId: 'zombs-royale-io', officialUrl: 'https://www.gamepix.com/play/zombs-royale-io'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/gold-strike-icy-cave.svg', providerGameId: 'gold-strike-icy-cave', officialUrl: 'https://www.gamepix.com/play/gold-strike-icy-cave'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/cut-the-rope.svg', providerGameId: 'cut-the-rope', officialUrl: 'https://www.gamepix.com/play/cut-the-rope'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/snail-bob-8.svg', providerGameId: 'snail-bob-8', officialUrl: 'https://www.gamepix.com/play/snail-bob-8'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/color-road.svg', providerGameId: 'color-road', officialUrl: 'https://www.gamepix.com/play/color-road'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/highway-rider-motorbike-racing.svg', providerGameId: 'highway-rider-motorbike-racing', officialUrl: 'https://www.gamepix.com/play/highway-rider-motorbike-racing'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/drift-dudes.svg', providerGameId: 'drift-dudes', officialUrl: 'https://www.gamepix.com/play/drift-dudes'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/super-bike-the-champion.svg', providerGameId: 'super-bike-the-champion', officialUrl: 'https://www.gamepix.com/play/super-bike-the-champion'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/super-liquid-soccer.svg', providerGameId: 'super-liquid-soccer', officialUrl: 'https://www.gamepix.com/play/super-liquid-soccer'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/football-superstars-2024.svg', providerGameId: 'football-superstars-2024', officialUrl: 'https://www.gamepix.com/play/football-superstars-2024'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/penalty-shooters-2.svg', providerGameId: 'penalty-shooters-2', officialUrl: 'https://www.gamepix.com/play/penalty-shooters-2'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/soccer-free-kick.svg', providerGameId: 'soccer-free-kick', officialUrl: 'https://www.gamepix.com/play/soccer-free-kick'
  }),
  createGamePixGame({
    ...
    rating: 7.8, platform: 'Multi', releaseYear: 2025, category: 'Adventure', initials: 'FAW',
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/fireboy-and-watergirl-ice-temple.svg', providerGameId: 'fireboy-and-watergirl-ice-temple', officialUrl: 'https://www.gamepix.com/play/fireboy-and-watergirl-ice-temple'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/money-movers-3.svg', providerGameId: 'money-movers-3', officialUrl: 'https://www.gamepix.com/play/money-movers-3'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/stealth-master.svg', providerGameId: 'stealth-master', officialUrl: 'https://www.gamepix.com/play/stealth-master'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/stickman-army-team-battle.svg', providerGameId: 'stickman-army-team-battle', officialUrl: 'https://www.gamepix.com/play/stickman-army-team-battle'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/tower-defense-clash.svg', providerGameId: 'tower-defense-clash', officialUrl: 'https://www.gamepix.com/play/tower-defense-clash'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/mahjong-connect.svg', providerGameId: 'mahjong-connect', officialUrl: 'https://www.gamepix.com/play/mahjong-connect'
  }),
  createGamePixGame({
    ...
    gradient: 'bg-gradient-to-br from-cyan-500/30 to-violet-500/30',
    thumbnail: '/images/gamepix/solitaire-garden.svg', providerGameId: 'solitaire-garden', officialUrl: 'https://www.gamepix.com/play/solitaire-garden'
  }),
  createGamePixGame({
