...
export default function Footer() {
  return (
    <footer className="border-t border-[color:var(--white-05)] bg-nexa-navy/50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="bg-[color:var(--white-05)] border border-[color:var(--white-10)] text-[color:var(--text-secondary)] text-xs px-3 py-1 rounded-full">No Login</span>
            </div>
          </div>

          <div>
            <h2 className="text-[color:var(--text-primary)] font-semibold uppercase tracking-wider text-sm mb-4">Platform</h2>
          ...
          <div>
            <h2 className="text-[color:var(--text-primary)] font-semibold uppercase tracking-wider text-sm mb-4">Support</h2>
            <ul className="space-y-2.5">
              <li><Link href="/about" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">About Us</Link></li>
              <li><Link href="/faq" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">FAQ</Link></li>
              <li><Link href="/contact" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">Contact Us</Link></li>
            </ul>
          </div>

          <div>
            <h2 className="text-[color:var(--text-primary)] font-semibold uppercase tracking-wider text-sm mb-4">Legal</h2>
            <ul className="space-y-2.5">
              <li><Link href="/privacy" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">Terms of Service</Link></li>
              <li><Link href="/cookies" className="text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] text-sm transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
