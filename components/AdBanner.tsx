...
export default function AdBanner() {
  return (
    <div className="relative w-full max-w-5xl mx-auto my-6 glass rounded-xl overflow-hidden border border-nexa-violet/20 p-3 bg-nexa-black/60 shadow-[0_0_20px_rgba(124,58,237,0.1)]">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-2 px-3">
        ...
        <Link href="/games" className="flex items-center gap-2 bg-gradient-to-r from-nexa-violet to-violet-600 hover:from-violet-600 hover:to-nexa-violet text-[color:var(--text-primary)] text-xs font-bold px-5 py-2.5 rounded-lg transition-all shadow-lg whitespace-nowrap">
          <span>Play Now →</span>
        </Link>
      </div>
    </div>
