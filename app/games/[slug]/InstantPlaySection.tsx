    ...
    >
      <div className="flex items-center justify-between px-4 py-3 bg-[#15152a]/90 border-b border-white/5">
        <div className="flex items-center gap-3 min-w-0">
          <div
            className={`w-8 h-8 rounded-lg flex items-center justify-center ${game.gradient} font-black text-white text-sm`}
          >
            {game.initials}
          </div>
      ...
      >
        ...
        {hasError ? (
          <div className="absolute inset-0 z-20 bg-[#0a0a1a] flex flex-col items-center justify-center p-6 text-center">
            ...
            <button
              onClick={retry}
              className="bg-electric-violet text-white px-4 py-2 rounded-lg text-sm"
            >
              Retry
            </button>
          </div>
