...
const categoryImages: Record<string, string> = {
  action: '/images/categories/fighting.webp',
  ...
  ball: '/images/categories/basketball.webp',
  basketball: '/images/categories/basketball.webp',
  battle: '/images/categories/battle.webp',
  'beauty-dress-up': '/images/categories/cats.webp',
  bike: '/images/categories/racing.webp',
  block: '/images/categories/block.webp',
  board: '/images/categories/board.webp',
  boat: '/images/categories/flying.webp',
  ...
  casual: '/images/categories/arcade.webp',
  cats: '/images/categories/cats.webp',
  clicker: '/images/categories/match-3.webp',
  cooking: '/images/categories/building.webp',
  drawing: '/images/categories/drawing.webp',
  educational: '/images/categories/educational.webp',
  farming: '/images/categories/building.webp',
  ...
  horror: '/images/categories/monster.webp',
  'hyper-casual': '/images/categories/arcade.webp',
  idle: '/images/categories/brain.webp',
  io: '/images/categories/arcade.webp',
  'match-3': '/images/categories/match-3.webp',
  math: '/images/categories/math.webp',
  memory: '/images/categories/brain.webp',
  mmorpg: '/images/categories/rpg.webp',
  monster: '/images/categories/monster.webp',
  'open-world': '/images/categories/adventure.webp',
  platformer: '/images/categories/adventure.webp',
  ...
  runner: '/images/categories/racing.webp',
  sandbox: '/images/categories/building.webp',
  shooter: '/images/categories/air-combat.webp',
  simulation: '/images/categories/building.webp',
  snake: '/images/categories/snake.webp',
  space: '/images/categories/space.webp',
  sports: '/images/categories/sports.webp',
  stealth: '/images/categories/hidden-object.webp',
  strategy: '/images/categories/board.webp',
  survival: '/images/categories/monster.webp',
  tank: '/images/categories/air-combat.webp',
  'time-management': '/images/categories/brain.webp',
  trivia: '/images/categories/quiz.webp',
  tycoon: '/images/categories/building.webp',
  word: '/images/categories/quiz.webp',
  zombie: '/images/categories/monster.webp',
}
...
const categories: Category[] = [
  ...
  },
  {
    ...
    accent: 'from-nexa-violet/70 to-nexa-blue/20',
    image: '/images/categories/cats.webp',
  },
  {
    slug: '2048',
    title: '2048',
