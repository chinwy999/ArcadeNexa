...
const categoryMeta: Record<string, { desc: string; gradient: string; bg: string; icon: string; image?: string }> = {
  ...
  'airplane':           { desc: 'Flying & airplane games',         gradient: 'from-sky-500 to-blue-600',        bg: 'from-sky-500/20 to-blue-500/10',        icon: '✈️' },
  'basketball':         { desc: 'Basketball games',                gradient: 'from-orange-500 to-red-600',      bg: 'from-orange-500/20 to-red-500/10',      icon: '🏀' },
  ...
  'games-for-girls':    { desc: 'Games for girls',                 gradient: 'from-pink-500 to-rose-600',       bg: 'from-pink-500/20 to-rose-500/10',       icon: '👑' },
...
const categoryImages: Record<string, string> = {
  ...
  'animal': '/images/categories/adventure.webp',
  'cats': '/images/categories/adventure.webp',
  'monster': '/images/categories/zombie.webp',
    ...
    <div className="py-16 px-4 sm:px-6 max-w-7xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <p className="text-text-secondary text-lg">
          <span className="text-white font-bold">{games.length.toLocaleString()}</span> games across{' '}
