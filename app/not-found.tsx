...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 text-center animate-fade-in">
      <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-nexa-violet to-nexa-emerald flex items-center justify-center transform rotate-45 mb-6 shadow-[0_0_40px_rgba(124,58,237,0.4)]">
        <span className="text-nexa-black font-black text-3xl transform -rotate-45">!</span>
      </div>
      <h1 className="text-7xl font-black text-nexa-text-primary mb-4">404</h1>
      <h2 className="text-2xl font-bold text-nexa-text-primary mb-2">Arena Not Found</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link href="/" className="bg-nexa-violet hover:bg-violet-600 text-nexa-text-primary px-6 py-3 rounded-xl font-bold transition">Go Home</Link>
        <Link href="/games" className="border border-white/20 hover:bg-white/10 text-nexa-text-primary px-6 py-3 rounded-xl font-bold transition">Browse Games</Link>
