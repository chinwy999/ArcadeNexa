...
export default function TermsPage() {
  return (
    <div className="py-20 px-4 sm:px-6 max-w-4xl mx-auto animate-fade-in">
      <h1 className="text-5xl font-black text-nexa-text-primary mb-2">Terms of Service</h1>
      ...
      <div className="space-y-6 text-text-secondary">
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">1. Acceptance of Terms</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">2. Use of the Platform</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">3. Age Requirements</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">4. Intellectual Property</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">5. Disclaimer</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">6. Changes to Terms</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">7. Contact</h2>
