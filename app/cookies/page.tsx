    ...
    <div className="py-20 px-4 sm:px-6 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="space-y-6 text-[color:var(--text-secondary)]">
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">What Are Cookies?</h2>
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3">
              ...
              <div><strong className="text-[color:var(--text-primary)]">Essential Cookies</strong> — Required for the platform to function properly, such as remembering your preferences.</div>
            </li>
            <li className="flex gap-3">
              <span className="text-nexa-cyan font-bold">📊</span>
              <div><strong className="text-[color:var(--text-primary)]">Analytics Cookies</strong> — Help us understand how visitors use the platform so we can improve it. Data is anonymized.</div>
            </li>
            <li className="flex gap-3">
              <span className="text-amber-400 font-bold">⚙️</span>
              <div><strong className="text-[color:var(--text-primary)]">Preference Cookies</strong> — Remember your settings such as theme or display preferences.</div>
            </li>
          </ul>
        </section>

        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">Third-Party Cookies</h2>
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">How to Manage Cookies</h2>
          <p className="mb-3">You can control and manage cookies through your browser settings:</p>
          <ul className="space-y-2">
            <li>• <strong className="text-[color:var(--text-primary)]">Chrome:</strong> Settings → Privacy and Security → Cookies</li>
            <li>• <strong className="text-[color:var(--text-primary)]">Firefox:</strong> Settings → Privacy & Security → Cookies</li>
            <li>• <strong className="text-[color:var(--text-primary)]">Safari:</strong> Preferences → Privacy → Cookies</li>
            <li>• <strong className="text-[color:var(--text-primary)]">Edge:</strong> Settings → Privacy → Cookies</li>
          </ul>
