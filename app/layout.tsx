...
export const metadata: Metadata = {
  ...
  description: 'Play 13,485+ free HTML5 games instantly on ArcadeNexa. No download, no registration required. Action, Puzzle, Racing, Sports and more!',
  ...
  openGraph: {
    ...
    description: 'Play 13,485+ free HTML5 games instantly. No download, no registration required.',
    siteName: 'ArcadeNexa',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'ArcadeNexa - Free HTML5 Games Online',
    description: 'Play 13,485+ free HTML5 games instantly. No download required.',
  },
  robots: {
    index: true,
    follow: true,
    ...
    <html lang="en" dir="ltr">
      ...
      <body className="min-h-screen bg-space-black text-text-primary antialiased">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
          ...
          "name": "ArcadeNexa",
          "url": siteUrl,
          "description": "Free HTML5 gaming platform with 13,485+ instant play games"
        })}} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebSite",
