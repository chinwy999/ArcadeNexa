...
export default function PrivacyPage() {
  return (
    <div className="py-20 px-4 sm:px-6 max-w-4xl mx-auto animate-fade-in">
      <h1 className="text-5xl font-black text-[color:var(--text-primary)] mb-2">Privacy Policy</h1>
      <p className="text-[color:var(--text-secondary)] mb-10">Your privacy matters to us. Here is how we handle your data.</p>
      ...
      <div className="space-y-6 text-[color:var(--text-secondary)]">
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">2. Cookies</h2>
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">4. Data Sharing</h2>
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">6. Security</h2>
        ...
        <section className="glass p-6 rounded-xl border border-[color:var(--white-05)]">
          <h2 className="text-[color:var(--text-primary)] font-bold text-xl mb-3">7. Contact Us</h2>
          <p>If you have questions about our privacy practices, please reach out via our <a href="/contact" className="text-nexa-cyan hover:underline">Contact page</a>.</p>
        </section>
