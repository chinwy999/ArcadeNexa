...
export default function PrivacyPage() {
  return (
    <div className="py-20 px-4 sm:px-6 max-w-4xl mx-auto animate-fade-in">
      <h1 className="text-5xl font-black text-nexa-text-primary mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-text-secondary">
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">1. Information We Collect</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">2. Cookies</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">3. Third-Party Games</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">4. Data Sharing</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">5. Children's Privacy</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">6. Security</h2>
        ...
        <section className="glass p-6 rounded-xl border border-white/5">
          <h2 className="text-nexa-text-primary font-bold text-xl mb-3">7. Contact Us</h2>
