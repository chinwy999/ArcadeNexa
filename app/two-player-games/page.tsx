...
export const metadata: Metadata = {
  ...
  description: 'Play the best two player games online free. Compete with friends on the same device. No download, no login. 13,000+ free browser games including 2 player options.',
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#1a0a2e] to-[#0a0a0f] px-4 py-16 text-center">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <p className="mx-auto mb-6 max-w-2xl text-lg text-gray-300">
            ...
            ArcadeNexa has 13,000+ free browser games including the best 2 player games — no download, no login.
          </p>
